...
public class IzdanjaKontroler {
	...
	(String naziv, String jezik, List<Autor> autori, String opis, String udk, String isbn,
			Date godinaIzdanja, TipKoricenja koricenje, Izdavac izdavac) 
					throws IOException {
		int id = repo.noviID();
		Izdanje izdanje = new Izdanje(id, naziv, jezik, autori, opis, udk, isbn, godinaIzdanja, koricenje, izdavac);
