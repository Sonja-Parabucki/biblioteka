...
public class TabelaKnjiga extends JTable {

	private static final long serialVersionUID = 4563561892048765727L;
	
	public TabelaKnjiga(TabelaModelKnjiga tabelaModelKnjiga) {
		this.setRowSelectionAllowed(true);
		this.setColumnSelectionAllowed(true);
		this.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);
		this.setModel(tabelaModelKnjiga);
